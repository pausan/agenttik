...
func writeLoginPage(w http.ResponseWriter, status int, why, next string, ready bool) {
	...
	if err := loginPage.Execute(w, loginData{Why: why, Next: next, Ready: ready}); err != nil {
